#!/usr/bin/env python3
"""
Description: The goal here is that if between 2 queries, certain rows are
             removed from the dataset, the user doesnot miss items from
             dataset when changing pagess
"""
